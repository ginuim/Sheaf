...
import { sessionPreviewToAiResult } from "./lib/ai-edit-session";
...
function WorkspaceApp() {
  ...
  const handleFocusEditPreview = useCallback((preview: Parameters<typeof sessionPreviewToAiResult>[0]) => {
    editor.scrollToAiPreview(sessionPreviewToAiResult(preview));
  }, [editor.scrollToAiPreview]);
          ...
          >
            ...
            <div className="ai-agent-panel-slot relative z-20 min-h-0 overflow-hidden">
              {aiFeatureEnabled ? (
                ...
                onFocusEditPreview={handleFocusEditPreview}
